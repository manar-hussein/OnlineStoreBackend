        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDiscount = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Seller = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantsWishlist", x => new { x.ProductVariantsId, x.WishlistId });
                    table.ForeignKey(
                        name: "FK_ProductVariantsWishlist_ProductVariants_ProductVariantsId",
                        column: x => x.ProductVariantsId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ProductVariantsWishlist_Wishlist_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_CartItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantsWishlist_WishlistId",
                table: "ProductVariantsWishlist",
                column: "WishlistId");
